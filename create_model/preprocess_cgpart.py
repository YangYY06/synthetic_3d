...
def parse_args():
    ...
    parser.add_argument('--cgpart_dir', type=str, default='/home/wufei/Documents/pretrain_6d_pose/data/CGPart')
    parser.add_argument('--label_dir', type=str, default='/home/wufei/Documents/pretrain_6d_pose/data/CGPart/labels')
...
def main():
    ...
    for si, obj_name in enumerate(obj_info['info_pth']):
        ...
        shape_file = os.path.join(args.cgpart_dir, 'models', model_id, 'models', 'model_normalized.obj')

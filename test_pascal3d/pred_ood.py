...
def parse_args():
    ...
    parser.add_argument('--img_path', type=str,
                        default='/home/jiahao/pretrain_6d_pose/data/OOD_test_new_2')
    ...
    parser.add_argument('--type', type=str, default='pose')

    args = parser.parse_args()

    args.mesh_path = os.path.join(args.mesh_path, args.category)
    args.img_path = os.path.join(args.img_path, args.type,'images',args.category)
    args.anno_path = os.path.join(args.anno_path, args.type,'annotations',args.category)
